...
use route_bucket_backend::utils::error::ApplicationResult;
...
fn main() {
    ...
    repo.register(&sample1);
    log::info!("seed Route {} added!", sample1.id());
    repo.register(&sample2);
    log::info!("seed Route {} added!", sample2.id());
}
